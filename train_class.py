...
class TrainingModule:
    def __init__(model, optimizer, criterion, train_loader, val_loader, epochs, idx2target_vocab, test_loader, scheduler = None, checkpoint = True, early_stop = False):
        self.model = model
    ...
    def train(self):
        ...
        for epoch in range(epochs):
            ...
            test_loss, test_precision, test_recall, test_f1 = self.run_epoch(mode = 'val', dataloader = self.test_loader)
